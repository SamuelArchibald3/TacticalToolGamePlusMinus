...
pack_amount = 1,
description = "Deploys a dispenser which heals allied players within its radius at a rate of {calc.dispenser_heal_per_second} hp per second",
...
pack_amount = 1,
description = "Deploys a stationary sentry gun that shoots at enemies that come within its {ent.radius} radius. \nCan only shoots at players it can see.",
...
pack_amount = 2,
description = "Deploys an invisible trap which automatically stuns enemy players who walk into it for {ent.stun_duration} seconds. \nStunned units become invulnerable for the duration. \n( invulnerable units can still be executed )",
...
pack_amount = 1,
description = "Deploys a large boulder prop which deals {ent.damage} damage to enemy players who touch it. \n(The boulders killing damage is not an execution, it does not go through invulnerability or shield.)",
...
pack_amount = 2,
description = "Deploys a device which returns {ent.damage_return} damage to enemy players who damage it. \nMelee attacks on deflectors only return {ent.damage_return_melee} damage.",
...
tool_name = "tool_c4",
pack_amount = 1,
description = "Deploys a stationary device which explodes after {ent.fuse} seconds, unless it's destroyed beforehand. \nThe explosion ONLY damages enemy buildings. \nDeals {ent.damage} damage in a {ent.radius} AOE.",
...
tool_name = "tool_mine",
pack_amount = 0,
description = "Deploys stationary invisible mines which can be manually triggered to explode. \nThere is a {ent.fuse} second delay when triggering the explosion during which the mine is revealed. \nOnly hurts players.",
...
description = "Following a {tool.time_charge} second chargeup, repidly fires a large spread of bombs for {tool.time_barrage_level1} second. \nDuring the charge up, you become unable to move your view or body.  \nONLY hurts players. \nBuying multiple upgrades duration",
...
description = "Repairs the buildings you whack for {tool.heal_amount_building} hp per hit.\nBuying multiple upgrades rate of fire.",
...
description = "Blasts back all players and props within a {tool.radius} radius infront of you. \n{tool.cooldown} second cooldown. \nDoes not affect allied players.",
}
,
...
description = "Reduces damage by {calc.shield_reduction} for {tool.duration} seconds. \n{tool.cooldown} second cooldown.",
}
,
...
description = "Deploys a prop which heals the player who picks it up for {ent.heal_amount} hp. \nYou can pick it up as well. \n{tool.cooldown} second cooldown",
}
,
...
description = "Amplifies the rate of fire on your currently held weapon by {calc.rateoffire_amp} for {tool.duration} seconds. \n{tool.cooldown} second cooldown.",
}
,
...
description = "Increase your gravity and greatly reduce knockback effects. \nLasts until you press it again. \n{tool.toggle_cooldown} second wait between toggles.",
}
,
...
description = "Decreases your gravity for {tool.duration} seconds. \n{tool.cooldown} second cooldown.",
}
,
purchase_ensnare =
{
...
description = "Freeze all nearby enemy players for {tool.duration} seconds. \nFrozen enemies can still aim and use tools. \n{tool.radius} AOE radius \n{tool.cooldown} second cooldown.",
}
,
