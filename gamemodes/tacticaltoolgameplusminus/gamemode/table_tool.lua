...
print_name = "Avia",
class = "ability",
single_use = true,	--one use per purchase, then it leaves the slot. Buy it again next round
cooldown = 0,		--nothing to come back from: a single use ability never gets a second press
gravity = 0.3,
duration = 8,
sound_on = Sound( "weapons/buffed_on.wav" ),	--CHANGE THIS TO SOMETHING NOT FROM TF2
sound_off = Sound( "weapons/buffed_off.wav" ),
