...
--Start_CaptureCheck, which was defined down here at the time, so anything that
--genuinely skipped setup would have called a nil global. That is why the tie
--breaker skips the wait rather than the phase.
--
--The capture system that used to sit below has moved to capturetimer.lua, which
--had a second copy of it. The header there says which copy survived and why.
